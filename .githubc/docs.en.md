...
- [Non-basic rules](#non-basic-rules)
  - [Cosmetic rules](#cosmetic-rules)
    - [Element hiding rules](#element-hiding-rules)
      - [Syntax](#syntax-2)
      - [Examples](#examples-3)
    ...
    - [Extended CSS selectors](#extended-css-selectors)
      - [Syntax](#syntax-4)
      - [Examples](#examples-5)
        - [Pseudo-class `:has()`](#pseudo-class-has)
        - [Pseudo-class `:if-not()`](#pseudo-class-if-not)
        - [Pseudo-class `:contains()`](#pseudo-class-contains)
        - [Pseudo-class `:matches-css()`](#pseudo-class-matches-css)
        - [Pseudo-class `:matches-attr()`](#pseudo-class-matches-attr)
        - [Pseudo-class `:matches-property()`](#pseudo-class-matches-property)
        - [Pseudo-class `:xpath()`](#pseudo-class-xpath)
        - [Pseudo-class `:nth-ancestor()`](#pseudo-class-nth-ancestor)
        - [Pseudo-class `:upward()`](#pseudo-class-upward)
        - [Pseudo-class `:remove()` and pseudo-property `remove`](#pseudo-class-remove-and-pseudo-property-remove)
  ...
  - [Scriptlet rules](#scriptlet-rules)
    - [Syntax](#syntax-7)
    - [Examples](#examples-7)
  - [Modifiers](#modifiers-1)
    ...
    - [path](#path)
      - [Syntax](#syntax-9)
  - [Information for filters maintainers](#information-for-filters-maintainers)
    - [Pre-processor directives](#pre-processor-directives)
      - [Including a file](#including-a-file)
      - [Conditions](#conditions)
      - [Safari affinity](#safari-affinity)
    - [Hints](#hints)
      - [Syntax](#syntax-10)
      - [NOT_OPTIMIZED hint](#not_optimized-hint)
      - [PLATFORM and NOT_PLATFORM hints](#platform-and-not_platform-hints)
  - [How to debug filtering rules](#how-to-debug-filtering-rules)
